    ...
    >
        ...
        <div className="absolute top-4 left-4 right-4 flex justify-between items-start">
          {featured && (
            <motion.div
              ...
              animate={{ scale: 1, x: 0 }}
              className="bg-emerald-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg"
            >
              Featured
            </motion.div>
          )}
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {tags.map((tag, i) => (
            <motion.span
              ...
              className="px-4 py-2 bg-emerald-500 text-white rounded-full text-sm font-medium shadow-sm hover:shadow-md transition-shadow"
            >
              {tag}
            </motion.span>
          ))}
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className="inline-flex items-center gap-2 bg-teal-600 text-white px-6 py-3 rounded-xl font-semibold shadow-md hover:shadow-lg hover:bg-teal-700 transition-all"
        >
      ...
      <motion.div
        ...
        className="absolute -bottom-8 -right-8 w-32 h-32 bg-gradient-to-br from-teal-200 to-emerald-200 opacity-20 rounded-lg"
      />
    </motion.div>
  );
}