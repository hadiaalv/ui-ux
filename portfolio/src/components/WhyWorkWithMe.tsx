...
export default function WhyWorkWithMe() {
  return (
    <section className="bg-[#f5faff] px-6 py-10 md:px-16 md:py-12">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 max-w-2xl">
          <p className="mb-3 text-sm font-bold uppercase tracking-[0.25em] text-[#2b6cb0]">Why Work With Us</p>
          <h2 className="mb-4 text-4xl font-extrabold leading-[0.9] tracking-[-0.06em] text-[#143f78] md:text-6xl">A design partner built around momentum</h2>
